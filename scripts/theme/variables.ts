export const variables = {
    ...
    buttonMinSize: [80, 28],
    buttonIconFileColor: 'color(var(colorAccent) a(0.80))',
    ...
    sidebarLabelSelectedBackground: ['foreground', 0.05],
    sidebarLabelSelectedColor: ['foreground', 1],
